  ...
  const saveMember = async () => {
    ...
    try {
      const { data } = await api.post('/members', {
        ...
        bank: form.bank.trim() || 'N/A',
        account_no: form.account_no.trim() || 'N/A',
      })
      ...
      setForm({
        ...
        phone: '',
        national_id: '',
        bank: form.bank, // keep bank for convenience
        account_no: '',
      })
    } catch (e: any) {
  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.inputWrapper}>
          <Ionicons name="business-outline" size={18} color="#8c6239" style={styles.inputIcon} />
          <TextInput
            placeholder="e.g. Kenya Commercial Bank"
            placeholderTextColor="#9e8e7e"
            value={form.bank}
            onChangeText={(v) => handleChange('bank', v)}
            style={styles.input}
          />
        </View>
        ...
        <View style={styles.inputWrapper}>
          <Ionicons name="wallet-outline" size={18} color="#8c6239" style={styles.inputIcon} />
          <TextInput
        ...
        <Text style={styles.footerHint}>
          After saving, the form clears ready for the next member.
        </Text>
      </ScrollView>
    </KeyboardAvoidingView>
  )
...
const styles = StyleSheet.create({
  ...
  inputWrapper: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: '#fff',
    borderRadius: 12, borderWidth: 1, borderColor: '#d9d0c7',
    marginBottom: 16,
