...
export default function RecordDeliveryScreen() {
  ...
  } = usePrintBluetoothPrompt('printReceiptPreference');
  ...
  const headerRight = (
    <View style={styles.headerRightContainer}>
      ...
      <View style={[styles.statusIndicator, isOnline ? styles.onlineBg : styles.offlineBg]}>
        {/* Wifi: 3 arcs drawn as rounded borders with overflow hidden */}
        {isOnline ? (
          ...
          /* Offline: simple X drawn from two rotated bars */
      ...
      {/* Print toggle — always tappable; saves preference regardless of printer state */}
      <TouchableOpacity
        style={[
          styles.printToggle,
